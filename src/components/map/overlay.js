...
export default class DeckGLOverlay extends Component {
            ...
            data.forEach(p => {
                if (p.zoomLevels[z] === undefined) {
                    ...
                    const neighbors = tree
                        ...
                        .filter(
                            neighbor => neighbor.zoomLevels[z] === undefined
                        )
    ...
    render() {
        let { viewport, data, iconAtlas, iconMapping, showCluster } = this.props
        ...
        const size = showCluster
            ? 1
            : Math.min(Math.pow(1.5, viewport.zoom - 10), 1)
        ...
        const layer = new IconLayer({
            ...
            getIcon: d =>
                showCluster
                    ? d.zoomLevels[z] && d.zoomLevels[z].icon
                    : 'marker',
            getSize: d =>
                showCluster ? d.zoomLevels[z] && d.zoomLevels[z].size : 1,
